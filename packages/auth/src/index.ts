      ...
      emailOTP({
        async sendVerificationOTP({ email, otp, type }) {
          ...
          if (type === "sign-in") {
            ...
            if (!u) {
              console.warn(`[Security] Blocked sign-in OTP email for unregistered address: ${email}`);
              return;
            }
            ...
            if (!u) {
              console.warn(`[Security] Blocked forget-password OTP email for unregistered address: ${email}`);
              return;
            }
