					...
					<section id="step-start" className="auth-enter">
						...
						>
							...
							<button
								...
								className="h-11 w-full cursor-pointer rounded-md bg-primary font-bold text-primary-foreground text-sm shadow-sm transition-all hover:bg-primary/90 active:scale-[0.96] disabled:cursor-not-allowed disabled:opacity-60"
							>
					...
					<section id="step-password" className="auth-enter">
						...
						<div className="mt-3 text-center">
							<button
								...
								className="cursor-pointer font-semibold text-muted-foreground text-sm hover:text-foreground"
							>
								Skip for now
							</button>
						</div>
